...
class TestConversions(TestCase):
    ...
    def test_structure_to_oxidstructure(self):
        ...
        print(df["structure"].iloc[0][list(df["structure"])[1]].iloc[0])
        self.assertEqual(df["structure"].iloc[0][list(df["structure"])[1]].iloc[0][0].specie.oxi_state, -1)
