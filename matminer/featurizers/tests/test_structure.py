...
class StructureFeaturesTest(PymatgenTest):
    ...
    def test_rdf_and_peaks(self):
        ...
        self.assertEquals(np.count_nonzero(rdf['distribution']), 116)
    ...
    def test_op_structure_fingerprint(self):
        ...
        self.assertAlmostEqual(int(opvals[10][0] * 1000 + 0.5), 999)
        self.assertAlmostEqual(int(opvals[10][1] * 1000 + 0.5), 999)
        ...
        self.assertAlmostEqual(int(opvals[40] * 1000 + 0.5), 999)
        self.assertAlmostEqual(int(opvals[41] * 1000 + 0.5), 0)
        self.assertAlmostEqual(int(opvals[42] * 1000 + 0.5), 999)
        self.assertAlmostEqual(int(opvals[43] * 1000 + 0.5), 999)
