...
class StructureFeaturesTest(PymatgenTest):
    ...
    def test_op_structure_fingerprint(self):
        ...
        self.assertAlmostEqual(round(opvals[10][0]), 1)
        self.assertAlmostEqual(round(opvals[10][1]), 1)
        opvals = op_struct_fp.featurize(self.nacl)
        self.assertAlmostEqual(round(opvals[16][0]), 1)
        self.assertAlmostEqual(round(opvals[16][1]), 1)
        opvals = op_struct_fp.featurize(self.cscl)
        self.assertAlmostEqual(round(opvals[20][0]), 1)
        self.assertAlmostEqual(round(opvals[20][1]), 1)

        # Test stats.
        op_struct_fp = OPStructureFingerprint()
        opvals = op_struct_fp.featurize(self.diamond)
        self.assertAlmostEqual(round(opvals[0]), 0)
        self.assertAlmostEqual(round(opvals[1]), 0)
        self.assertAlmostEqual(round(opvals[2]), 0)
        self.assertAlmostEqual(round(opvals[3]), 0)
        self.assertAlmostEqual(round(opvals[4]), 0)
        self.assertAlmostEqual(round(opvals[32]), 0)
        self.assertAlmostEqual(round(opvals[40]), 1)
        self.assertAlmostEqual(round(opvals[41]), 0)
        self.assertAlmostEqual(round(opvals[42]), 1)
        self.assertAlmostEqual(round(opvals[43]), 1)
        self.assertAlmostEqual(round(opvals[44]), 0)
        for i in range(52, len(opvals)):
            self.assertAlmostEqual(round(opvals[i]), 0)
